...
//        sleep(250);
        ...
        driveController.forwards(1.25, 0.4);
        imuController.rotate(-90, 0.4, driveController);
        driveController.left(0.1, 0.2);
        slideController.goToPosInStack(5, 1);
        driveController.forwards(0.8, 0.7);
        ...
        slideController.goToPos(LinearSlideController.LinearSlidePosition.HIGH, 0.8);

        sleep(500);

        driveController.backwards(1, 0.7);
        ...
        sleep(250);
        clawController.clawLeft();
        slideController.goToPosInStack(4, 1);

        // second cone

        driveController.forwards(1.26, 0.8);
        driveController.forwards(0.2, 0.2);

        clawController.toggleClaw();
        sleep(250);
        slideController.goToPos(LinearSlideController.LinearSlidePosition.HIGH, 1);
        sleep(500);
        driveController.backwards(1.1, 0.6);
        driveController.backwardUntilPoleAndAdjust(rightDistanceController);
        clawController.clawRight();
        sleep(500);
        ...
        // park
        driveController.forwards(0.5, 0.4);

//        // Go to correct square
        if(color.equals("red")) {

            driveController.forwards(1.2, 0.6);
            ...
            driveController.backwards(0.9, 0.5);
